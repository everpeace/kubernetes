...
func Validate_DeviceAttributeListType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *resourcev1.DeviceAttributeListType) (errs field.ErrorList) {
	...
	// field resourcev1.DeviceAttributeListType.IntValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []int64, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("ints"), obj.IntValues, safe.Field(oldObj, func(oldObj *resourcev1.DeviceAttributeListType) []int64 { return oldObj.IntValues }), oldObj != nil)...)

	// field resourcev1.DeviceAttributeListType.BoolValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []bool, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("bools"), obj.BoolValues, safe.Field(oldObj, func(oldObj *resourcev1.DeviceAttributeListType) []bool { return oldObj.BoolValues }), oldObj != nil)...)

	// field resourcev1.DeviceAttributeListType.StringValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("strings"), obj.StringValues, safe.Field(oldObj, func(oldObj *resourcev1.DeviceAttributeListType) []string { return oldObj.StringValues }), oldObj != nil)...)

	// field resourcev1.DeviceAttributeListType.VersionValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("versions"), obj.VersionValues, safe.Field(oldObj, func(oldObj *resourcev1.DeviceAttributeListType) []string { return oldObj.VersionValues }), oldObj != nil)...)
