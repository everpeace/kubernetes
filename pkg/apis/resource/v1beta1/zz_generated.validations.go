...
var unionMembershipFor_k8s_io_api_resource_v1beta1_DeviceAttribute_ = validate.NewUnionMembership(validate.NewUnionMember("int"), validate.NewUnionMember("bool"), validate.NewUnionMember("string"), validate.NewUnionMember("version"), validate.NewUnionMember("list"))
...
func Validate_DeviceAttribute(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *resourcev1beta1.DeviceAttribute) (errs field.ErrorList) {
	...
	// field resourcev1beta1.DeviceAttribute.ListValue
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj *resourcev1beta1.DeviceAttributeListType, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
				return nil
			}
			...
			return
		}(fldPath.Child("list"), obj.ListValue, safe.Field(oldObj, func(oldObj *resourcev1beta1.DeviceAttribute) *resourcev1beta1.DeviceAttributeListType {
...
var unionMembershipFor_k8s_io_api_resource_v1beta1_DeviceAttributeListType_ = validate.NewUnionMembership(validate.NewUnionMember("ints"), validate.NewUnionMember("bools"), validate.NewUnionMember("strings"), validate.NewUnionMember("versions"))

// Validate_DeviceAttributeListType validates an instance of DeviceAttributeListType according
// to declarative validation rules in the API schema.
func Validate_DeviceAttributeListType(ctx context.Context, op operation.Operation, fldPath *field.Path, obj, oldObj *resourcev1beta1.DeviceAttributeListType) (errs field.ErrorList) {
	errs = append(errs, validate.Union(ctx, op, fldPath, obj, oldObj, unionMembershipFor_k8s_io_api_resource_v1beta1_DeviceAttributeListType_, func(obj *resourcev1beta1.DeviceAttributeListType) bool {
		if obj == nil {
			return false
		}
		return obj.IntValues != nil
	}, func(obj *resourcev1beta1.DeviceAttributeListType) bool {
		if obj == nil {
			return false
		}
	...
	// field resourcev1beta1.DeviceAttributeListType.IntValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []int64, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("ints"), obj.IntValues, safe.Field(oldObj, func(oldObj *resourcev1beta1.DeviceAttributeListType) []int64 { return oldObj.IntValues }), oldObj != nil)...)

	// field resourcev1beta1.DeviceAttributeListType.BoolValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []bool, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("bools"), obj.BoolValues, safe.Field(oldObj, func(oldObj *resourcev1beta1.DeviceAttributeListType) []bool { return oldObj.BoolValues }), oldObj != nil)...)

	// field resourcev1beta1.DeviceAttributeListType.StringValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("strings"), obj.StringValues, safe.Field(oldObj, func(oldObj *resourcev1beta1.DeviceAttributeListType) []string { return oldObj.StringValues }), oldObj != nil)...)

	// field resourcev1beta1.DeviceAttributeListType.VersionValues
	errs = append(errs,
		func(fldPath *field.Path, obj, oldObj []string, oldValueCorrelated bool) (errs field.ErrorList) {
			// don't revalidate unchanged data
			if oldValueCorrelated && op.Type == operation.Update && equality.Semantic.DeepEqual(obj, oldObj) {
			...
			return
		}(fldPath.Child("versions"), obj.VersionValues, safe.Field(oldObj, func(oldObj *resourcev1beta1.DeviceAttributeListType) []string { return oldObj.VersionValues }), oldObj != nil)...)
