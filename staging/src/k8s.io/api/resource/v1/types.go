...
type DeviceAttribute struct {
	...
	ListValue *DeviceAttributeListType `json:"list,omitempty" protobuf:"bytes,6,opt,name=list"`
}
...
type CELDeviceSelector struct {
	...
	// the include() helper is available and it can work for both scalar
	...
	//
	//     device.attributes["dra.example.com"].models.include("some-model")
	//
